    ...
    <>
      <div className="bg-gray_900 flex flex-col font-poppins items-end justify-start mx-[auto] sm:pl-[15px] md:pl-[40px] pl-[62px] w-[100%]">
        <div className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end max-w-[1450px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <div
            className="bg-cover bg-no-repeat flex flex-col items-center justify-start md:ml-[117px] ml-[180px] sm:mx-[0] sm:w-[100%] w-[53%]"
            style={{ backgroundImage: "url('images/img_group45.png')" }}
          >
            <div className="bg-gray_900_33 flex flex-col items-center justify-end sm:pt-[15px] md:pt-[505px] pt-[772px] w-[100%]">
              <div className="bg-gray_900_07 flex flex-row md:flex-wrap sm:flex-wrap items-start justify-end md:p-[13px] sm:p-[15px] p-[20px] w-[100%]">
                <div className="flex flex-col justify-start md:mb-[11px] mb-[17px] sm:mb-[8px] mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[53%]">
                  <Text
                ...
                <Stack className="h-[111px] md:ml-[110px] ml-[169px] sm:ml-[85px] sm:mt-[28px] md:mt-[37px] mt-[57px] relative w-[12%]">
                  <Img
                  ...
                  <Img
                    ...
                    className="absolute h-[70px] max-w-[100%] sm:w-[35px] md:w-[45px] w-[70px]"
                    alt="CircledDownLe"
                  />
                  <Img
                ...
                <div className="flex flex-col items-end justify-start md:mr-[4px] mr-[7px] sm:mt-[34px] md:mt-[44px] mt-[68px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[11%]">
                  <Text
                  ...
                  <Img
                    ...
                    className="common-pointer sm:h-[36px] md:h-[46px] h-[70px] max-w-[100%] mr-[2px] mt-[3px] sm:w-[35px] md:w-[45px] w-[70px]"
