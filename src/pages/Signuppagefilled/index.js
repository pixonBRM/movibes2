...
const SignuppagefilledPage = () => {
  ...
  function handleNavigate10() {
    navigate("/signuppageprocessingone");
  }
    ...
    <>
      <div className="bg-gray_900 flex flex-row md:flex-wrap sm:flex-wrap font-poppins items-start mx-[auto] sm:pr-[15px] md:pr-[53px] pr-[81px] w-[100%]">
        ...
        <div className="flex flex-col justify-start max-w-[415px] sm:ml-[40px] md:ml-[52px] ml-[auto] mr-[auto] md:mt-[114px] mt-[175px] sm:mt-[88px] sm:pl-[15px] sm:pr-[15px] w-[100%]">
          ...
          <div className="flex flex-col items-center justify-start ml-[10px] md:ml-[6px] sm:mt-[25px] md:mt-[33px] mt-[51px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[96%]">
            <div className="flex flex-col justify-start w-[100%]">
              ...
              <Line className="bg-gray_800 h-[1px] md:mt-[11px] mt-[17px] sm:mt-[8px] w-[100%]" />
            </div>
            <Input
              className="font-normal not-italic p-[0] text-[20px] placeholder:text-gray_400 text-gray_400 w-[100%]"
              wrapClassName="md:mt-[24px] mt-[38px] sm:mt-[19px] w-[100%]"
              type="email"
              name="email"
              placeholder="oliviabrooke3435@gmail.com"
              size="md"
            ></Input>
            <div className="flex flex-col justify-start sm:mt-[16px] md:mt-[21px] mt-[33px] w-[100%]">
              <Text
                className="font-normal not-italic text-gray_400 w-[auto]"
                as="h3"
                variant="h3"
              ...
              <Line className="bg-gray_800 h-[1px] mt-[15px] sm:mt-[7px] md:mt-[9px] w-[100%]" />
            </div>
            <Button
              className="common-pointer cursor-pointer font-semibold sm:mt-[30px] md:mt-[39px] mt-[61px] sm:text-[18px] md:text-[20px] text-[22px] text-center text-gray_900 w-[100%]"
...
export default SignuppagefilledPage;
